...
namespace XmlDataWorkerTests.ModelTests.DataSaversTests
{
    public sealed class ReadWriteXmlTestsUsingXmlWriterStreamReader
    {
        ...
        {
            var writerToXml = new XmlSaveLoader<DieselFuel>(new StreamReaderLoader(), new XmlWriterToXml<DieselFuel>(), new FromXmlLiquidFactory<DieselFuel>());
        ...
        public void TestWritingReadingOctane_Pertol95DataInXml()
        {
            ...
            var writerToXml = new XmlSaveLoader<OctanePetrol_95>(new StreamReaderLoader(), new XmlWriterToXml<OctanePetrol_95>(), new FromXmlLiquidFactory<OctanePetrol_95>());
            writerToXml.Save(expectedFuel);
        ...
        public void TestWritingReadingNeedFrozeProductDataInXml()
        {
            ...
            var writerToXml = new XmlSaveLoader<Milk>(new StreamReaderLoader(), new XmlWriterToXml<Milk>(), new FromXmlNeedFrozenProductFactory<Milk>());
        ...
        public void TestWritingReadingTankSemitrailertDataInXml()
        {
            ...
            var writerToXml = new XmlSaveLoader<TankSemitrailer>(new StreamReaderLoader(), new XmlWriterToXml<TankSemitrailer>(), new FromXmlTankSemitrailerFactory());
        ...
        public void TestWritingRefrigeratorSemitrailertDataInXml()
        {
            ...
            var writerToXml = new XmlSaveLoader<RefrigeratorSemitrailer>(new StreamReaderLoader(), new XmlWriterToXml<RefrigeratorSemitrailer>(), new FromXmlRefrigeratorSemitrailerFactory());
            writerToXml.Save(expectedSemitrailer);
        ...
        public void TestWritingTiltSemitrailerDataInXml()
        {
            ...
            var writerToXml = new XmlSaveLoader<TiltSemitrailer>(new StreamReaderLoader(), new XmlWriterToXml<TiltSemitrailer>(), new FromXmlTiltSemitrailerFactory());
            writerToXml.Save(expectedSemitrailer);
        ...
        public void TestWritingMANTractorDataInXml()
        {
            ...
            var serializer = new XmlSaveLoader<MANTractor>(new StreamReaderLoader(), new XmlWriterToXml<MANTractor>(), new FromXmlTractorFactory<MANTractor>());
